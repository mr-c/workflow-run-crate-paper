...
%DIF DEL ./second_submission/wrroc.tex   Mon Aug 26 13:40:54 2024
%DIF ADD ../wrroc.tex                    Tue Aug 27 10:51:39 2024
...
%DIF 167c167
%DIF < %\lhead{\includegraphics[width=2.0in]{PLOS-submission.eps}}
%DIF -------
...
within PROV (based on the \emph{wfdesc} model), in practice its implementation does not include tool definitions or file formats.
%DIF < , as proposed by the wfdesc extension Roterms~\cite{Soiland-Reyes 2015}.
...
In the rest of the text and images, the \DIFdelbegin \DIFdel{following prefixes }\DIFdelend \DIFaddbegin \DIFadd{abbreviation prefixes in Table~\ref{tab:prefix} }\DIFaddend are used to represent the \DIFdelbegin \DIFdel{corresponding namespaces:
}\DIFdelend \DIFaddbegin \DIFadd{various namespaces.
}

\begin{table}[h]
\DIFaddendFL \begin{tabular}{rcl}
\DIFaddbeginFL {\bf \DIFaddFL{Abbrev.\ Prefix}} &           & {\bf \DIFaddFL{Namespace}} \\ \hline
\DIFaddendFL \emph{s:}         & $\rightarrow$ & \url{https://schema.org/} \\
\emph{bioschemas:}& $\rightarrow$ & \url{https://bioschemas.org/} \\
\emph{bsp:}       & $\rightarrow$ & \url{https://bioschemas.org/properties/} \\
\emph{wfrun:}     & $\rightarrow$ & \url{https://w3id.org/ro/terms/workflow-run\#} \\ \hline
\end{tabular}
\DIFaddbeginFL \caption{%DIF > 
\DIFaddFL{The various namespaces used in this work are referenced through the abbreviation prefixes shown in this table.
}}
\label{tab:prefix}
\end{table}
\DIFaddend 
...
Fig~\ref{fig:process_crate_er} shows the classes used in Process Run Crate together with their relationships.
...
\DIFaddbeginFL \DIFaddFL{The term prefix }\emph{\DIFaddFL{s:}} \DIFaddFL{represents the namespace }\url{https://schema.org/}\DIFaddFL{.
}\DIFaddendFL }
...
Fig~\ref{fig:head_sort} contains a diagram of the two actions and their relationships to the other involved entities.
...
Fig~\ref{fig:workflow_crate_er} illustrates the classes used in this profile together with their relationships.
%
...
\termbsp{output} correspond to formal parameters, which acquire a value when the workflow is run (see Fig~\ref{fig:workflow_crate_er}).
...
\DIFaddbeginFL \DIFaddFL{The term prefixes are defined in Table~\ref{tab:prefix}.
}\DIFaddendFL %Prefixes and namespaces are 
...
%
Fig~\ref{fig:provenance_crate_er} illustrates the various classes involved in the representation of a workflow run via Provenance Run Crate together with their relationships.
...
As an example, consider again the workflow depicted in Fig~\ref{fig:head_sort},
...
\end{itemize}
%
The RO-Crate metadata files for the \DIFdelbegin \DIFdel{machine readable }\DIFdelend \DIFaddbegin \DIFadd{machine-readable }\DIFaddend profiles can be retrieved using the same URLs as the human-readable ones, but with \DIFdelbegin \DIFdel{JSON-LD content negotiation : this is done by setting }\texttt{\DIFdel{"Accept:application/ld+json"}} %DIFAUXCMD
\DIFdel{in the HTTP header}\DIFdelend \DIFaddbegin \DIFadd{an appropriate HTTP content negotiation header; at the time of writing JSON-LD, Turtle, RDF/XML and N-triples serializations are available}\DIFaddend .

The new terms we defined to represent concepts that could not be expressed with existing Schema.org ones are at:
%
\begin{itemize}
    \item \DIFdelbegin %DIFDELCMD < \url{https://w3id.org/ro/terms/workflow-run}
%DIFDELCMD < %%%
...
%DIF >  Include for preprint, Remove when submitting to PLOS One:
\DIFaddbegin \iffalse
...
%DIFDELCMD < %%%
\DIFdelend \bibitem{Scheidegger 2008}
...
\DIFaddbegin \bibitem{Garijo 2014}
\DIFadd{Garijo D, Gil Y, Corcho O.
Towards Workflow Ecosystems through Semantic and Standard Representations.
In Proceedings of the 9th Workshop on Workflows in Support of Large-Scale Science 2014.
doi: }\href{https://doi.org/10.1109/works.2014.13}{\DIFadd{10.1109/works.2014.13}}

\DIFaddend \bibitem{Samuel 2022}
...
\bibitem{cwl-implementations}
Common Workflow Language Implementations [cited 2024 May 24].
\url{https://www.commonwl.org/implementations/}

\DIFdelbegin \bibitem{Soiland-Reyes 2015}
\DIFdel{Soiland-Reyes S.
The Roterms ontology. Release 30 July 2015 }%DIFDELCMD < [%%%
\DIFdel{cited 2024 May 24}%DIFDELCMD < ]%%%
\DIFdel{.
}%DIFDELCMD < \url{https://wf4ever.github.io/ro/2016-01-28/roterms/}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Amstutz 2023}
...
\DIFaddbegin \bibitem{profiles-ro-crate}
...
\DIFaddbegin \bibitem{WRROC 2024a}
\DIFadd{Workflow Run RO-Crate working group.
Process Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12158562}{\DIFadd{10.5281/zenodo.12158562}}

\bibitem{WRROC 2024b}
\DIFadd{Workflow Run RO-Crate working group.
Workflow Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12159311}{\DIFadd{10.5281/zenodo.12159311}}

\bibitem{WRROC 2024c}
\DIFadd{Workflow Run RO-Crate working group.
Provenance Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12160782}{\DIFadd{10.5281/zenodo.12160782}}

\DIFaddend \bibitem{cqs-sparql-queries}
...
\DIFdelbegin \bibitem{run-crate-repository}
\DIFdel{Workflow Run RO-Crate GitHub repository }%DIFDELCMD < [%%%
\DIFdel{cited 2024 July 2}%DIFDELCMD < ]%%%
\DIFdel{.
}%DIFDELCMD < \url{https://github.com/ResearchObject/workflow-run-crate}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{roc-context}
...
\bibitem{computational-workflow-profile}
...
\DIFdelbegin \bibitem{WRROC 2024a}
\DIFdel{Workflow Run RO-Crate working group.
Process Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12158562}{\DIFdel{10.5281/zenodo.12158562}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend %\bibitem{Meurisse 2023}
...
\DIFdelbegin \bibitem{WRROC 2024b}
\DIFdel{Workflow Run RO-Crate working group.
Workflow Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12159311}{\DIFdel{10.5281/zenodo.12159311}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Koster 2012}
Köster J, Rahmann S.
...
\DIFdelbegin \bibitem{WRROC 2024c}
\DIFdel{Workflow Run RO-Crate working group.
Provenance Run Crate specification. Version 0.5.
Zenodo, 2024.
doi: }\href{https://doi.org/10.5281/zenodo.12160782}{\DIFdel{10.5281/zenodo.12160782}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{howtostep-def}
...
\DIFaddbegin \bibitem{Galaxy 2023}
\DIFadd{The Galaxy Community.
Galaxy. Version 23.1
Software Heritage Archive, 2023.
%DIF > \url{https://github.com/galaxyproject/galaxy/releases/tag/v23.1.1}\\
...
\DIFaddbegin \bibitem{Rehm 2021}
\DIFadd{Rehm HL, Page AJH, Smith L, Adams JB, Alterovitz G, Babb LJ, et al.
GA4GH: International policies and standards for data sharing across genomic research and healthcare.
Cell Genomics 2021;1(2):100029.
doi: }\href{https://doi.org/10.1016/j.xgen.2021.100029}{\DIFadd{10.1016/j.xgen.2021.100029}}

\DIFaddend %\bibitem{Magee 2018}
...
\DIFdelbegin \bibitem{Kinoshita 2023}
\DIFdel{Kinoshita BP.
RO-Crate created using Autosubmit version 4.0.100 workflow running kinow/auto-mhm-test-domains.
Zenodo, 2023.
doi: }\href{https://doi.org/10.5281/zenodo.8144612}{\DIFdel{10.5281/zenodo.8144612}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Samaniego 2010}
...
\DIFaddbegin \bibitem{Kinoshita 2023}
\DIFadd{Kinoshita BP.
RO-Crate created using Autosubmit version 4.0.100 workflow running kinow/auto-mhm-test-domains.
Zenodo, 2023.
doi: }\href{https://doi.org/10.5281/zenodo.8144612}{\DIFadd{10.5281/zenodo.8144612}}

\DIFaddend \bibitem{run-pathology}
Leo S.
...
\DIFdelbegin \bibitem{Galaxy 2023}
\DIFdel{The Galaxy Community.
Galaxy. Version 23.1
Software Heritage Archive, 2023.
%DIF < \url{https://github.com/galaxyproject/galaxy/releases/tag/v23.1.1}\\
}%DIFDELCMD < \url{https://identifiers.org/swh:1:rel:33ce0ce4f6e3d77d5c0af8cff24b2f68ba8d57e9}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Colonnelli 2023}
Colonnelli I.
...
\bibitem{digital-pathology-platform}
CRS4 Digital Pathology Platform [cited 2024 May 27].
\url{https://github.com/crs4/DigitalPathologyPlatform}

\DIFdelbegin \bibitem{profiles-ro-crate}
\DIFdel{RO-Crate profiles }%DIFDELCMD < [%%%
\DIFdel{cited 2024 July 1}%DIFDELCMD < ]%%%
\DIFdel{.
}%DIFDELCMD < \url{https://www.researchobject.org/ro-crate/profiles.html\#ro-crate-profiles}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{mirax-format}
...
\DIFdelbegin \bibitem{Wittner 2023a}
\DIFdel{Wittner R, Gallo M, Leo S, Soiland-Reyes S.
Packing provenance using CPM RO-Crate profile. Version 1.1.
Zenodo, 2023.
doi: }\href{https://doi.org/10.5281/zenodo.8095888}{\DIFdel{10.5281/zenodo.8095888}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Wittner 2024}
...
\DIFaddbegin \bibitem{Wittner 2023a}
\DIFadd{Wittner R, Gallo M, Leo S, Soiland-Reyes S.
Packing provenance using CPM RO-Crate profile. Version 1.1.
Zenodo, 2023.
doi: }\href{https://doi.org/10.5281/zenodo.8095888}{\DIFadd{10.5281/zenodo.8095888}}

\DIFaddend \bibitem{sparql11-overview}
...
\DIFdelbegin \bibitem{Rehm 2021}
\DIFdel{Rehm HL, Page AJH, Smith L, Adams JB, Alterovitz G, Babb LJ, et al.
GA4GH: International policies and standards for data sharing across genomic research and healthcare.
Cell Genomics 2021;1(2):100029.
doi: }\href{https://doi.org/10.1016/j.xgen.2021.100029}{\DIFdel{10.1016/j.xgen.2021.100029}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{De Wit 2022}
de Wit R.
...
\DIFaddbegin \bibitem{Desai 2016}
\DIFadd{Desai T, Ritchie F, Welpton R.
...
\DIFdelbegin \bibitem{Desai 2016}
\DIFdel{Desai T, Ritchie F, Welpton R.
Five Safes: designing data access for research.
Economics Working Paper Series, 2016;1601.
}%DIFDELCMD < \url{https://econpapers.repec.org/RePEc:uwe:wpaper:20161601}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \bibitem{Snowley 2023} 
...
%Moreau, L., Missier, P., Belhajjame, K., Far, R. B., Cheney, J., Coppens, S., Cresswell, S., Gil, Y., Groth, P., Klyne, G., Lebo, T., McCusker, J., Miles, S., Myers, J., Sahoo, S., Tilmes, C.
